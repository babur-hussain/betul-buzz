...
const BusinessReviewManager: React.FC = () => {
                ...
                {filteredReviews.length === 0 ? (
                  ...
                  filteredReviews.map((review) => (
                    <TableRow key={review.id}>
                      ...
                      <TableCell>
                        <div>
                          <div className="font-medium">{review.business.name}</div>
                          <div className="text-sm text-gray-500">{review.business.category}</div>
                        </div>
                      </TableCell>
                      <TableCell>
                        <div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div><strong>Business:</strong> {selectedReview.business.name}</div>
                    <div><strong>Category:</strong> {selectedReview.business.category}</div>
                    <div><strong>User:</strong> {selectedReview.user.full_name}</div>
                    <div><strong>Email:</strong> {selectedReview.user.email}</div>
                  </div>
                </div>
              </div>
